      ...
      <div className={styles.container}>
        <AnimatedContent delay={0}>
          <div className={styles.textContainer}>
            ...
            <p className={styles.text}>私たちの使命は、midのクリエイティブやサービスを通じて企業や個人の魅力を最大化し、信頼され、長く愛される存在へと育てていくことです。</p>
            <p className={styles.text}>
            表面的なトレンドに流されることなく、人や企業が持つ本来の魅力や事業の本質に目を向けること。<br/>
            服づくりやデザイン、サービスや場づくり、人材を通じて、丁寧に言葉を交わしながらその核を形にし、持続する価値を築いていきます。
            </p>
          </div>
        </AnimatedContent>
      </div>
          ...
          <div className={styles.snsTop}>
            <div className={styles.snsTopImg}>
              <Image
                ...
                width={IMAGE_SIZES.SNS_TOP.width}
                height={IMAGE_SIZES.SNS_TOP.height}
                loading="lazy"
              />
            </div>
          </div>
          <p className={styles.playfairTitle}>S.N.S.</p>
          <ul className={styles.linkList}>
            <li className={styles.linkItem}>
              <Link href={SOCIAL_LINKS.instagram}>
                <div className={styles.circle}>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" width="20px" height="20px">
